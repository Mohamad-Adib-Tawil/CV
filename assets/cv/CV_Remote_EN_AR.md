...
## Selected Projects
- LKLK, Real-time Audio Rooms Social App: Flutter, Zego Express, ZIM, Appwrite, BLoC, GetIt, Hive, ProGuard/R8, Crashlytics. Public result: 5,000+ downloads.
- Wolfera, Automotive Marketplace: Flutter, Supabase, Clean Architecture, Dartz/Either, Infinite Pagination, GoRouter.
- Quran Ahmed Karasi, Offline Quran Reader & Audio App: Flutter, Clean Architecture, Cubit, just_audio, background_downloader, gen-i10n.
- Office Archiving, Document Scanning & OCR: Flutter, Google ML Kit, Tesseract OCR, SQLite, PDF Processing.
- Code Book, Offline Digital Library: Flutter, Clean Architecture, BLoC, GetIt, Hive, Dio, WebView, Open Library API.
